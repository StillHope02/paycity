...
// // ── Card Payment Page (screenshot se match) ───────────────────────────────
// const CardPaymentPage = ({ fine, discounted, onBack, onSuccess }) => {
...
//   const supportedCards = ["visa", "mastercard", "amex", "discover"];
//   const cardType = getCardType(cardNum);
//   const isUnsupported = cardNum.replace(/\s/g, "").length >= 6 && cardType && !supportedCards.includes(cardType);

//   const handleSubmit = () => {
//     if (!cardHolder || !cardNum || !expiry || !cvv || isUnsupported) return;
//     setProcessing(true);
//     setTimeout(() => { setProcessing(false); onSuccess(); }, 2000);
//   };
...
//     { label: "JCB", bg: "#003087" },
//     { label: "DISC", bg: "#e65c00" },
//     { label: "Maestro", bg: "#6c63ff" },
...
//           <button onClick={onBack} className="flex items-center gap-1 text-orange-500 text-sm font-semibold mb-4">
//             <ChevronLeft /> Back
//           </button>
...
//           {/* Notice + Total */}
//           <div className="bg-teal-50 border border-teal-100 rounded-lg px-4 py-4 mb-7">
//             <p className="text-gray-800 text-sm mb-1">
//               Notice Number : <span className="text-orange-500 font-semibold">{fine.ref}</span>
//             </p>
//             <p className="text-gray-800 text-sm">
//               Total Fine : <span className="text-red-600 font-bold text-base">R {discounted.toFixed(0)}</span>
//             </p>
//           </div>
...
//               className="w-full border border-gray-300 rounded px-3 py-3 text-sm outline-none focus:border-orange-400 transition-colors"
//             />
//           </div>
...
//             </label>
//             <div className={`flex items-center border rounded px-3 py-2.5 transition-colors ${isUnsupported ? "border-red-400" : "border-gray-300 focus-within:border-orange-400"}`}>
//               <input
...
//               />
//               {cardType && (
//                 <span className={`text-xs font-bold px-2 py-0.5 rounded ml-2 text-white ${
//                   cardType === "visa" ? "bg-blue-900" :
//                   cardType === "mastercard" ? "bg-red-600" :
//                   cardType === "amex" ? "bg-blue-500" :
//                   cardType === "discover" ? "bg-orange-500" :
//                   "bg-purple-600"
//                 }`}>
//                   {cardType === "visa" ? "VISA" : cardType === "mastercard" ? "MC" : cardType === "amex" ? "AMEX" : cardType === "discover" ? "DISC" : cardType.toUpperCase()}
//                 </span>
//               )}
//             </div>
//           </div>
...
//           {isUnsupported && (
//             <p className="text-red-500 text-sm mt-1 mb-2 leading-snug">
...
//             {cardLogos.map((c, i) => (
//               <span key={i} style={{ background: c.bg }}
...
//             className="w-full bg-orange-400 hover:bg-orange-500 disabled:bg-orange-300 text-white font-bold py-4 rounded-lg transition-all text-base flex items-center justify-center gap-2"
//           >
//             {processing
//               ? <><div className="w-5 h-5 border-2 border-white/40 border-t-white rounded-full animate-spin" /> Processing...</>
//               : "Submit"}
...
//   if (showPayment && fine) {
//     return <CardPaymentPage fine={fine} discounted={discounted} onBack={() => setShowPayment(false)} onSuccess={handleSuccess} />;
//   }
